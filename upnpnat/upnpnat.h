...
public:
	 ...
	 ***/
	bool add_port_mapping(const char* _description, const char* _destination_ip, unsigned short int _port_ex, unsigned short int _destination_port, const char* _protocal, unsigned int leasetime);//add port mapping
	bool del_port_mapping(unsigned short int _port_ex, const char* _protocal);
